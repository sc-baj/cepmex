# [+] Update BY KANG REKOD 
# [+] SCRIPT DENGAN USER AGENT GANAS
# [+] SELAMAT INI FREE BUAT YATIM 
...
sys.stdout.write('\x1b]2; BMBF MASTER PLER ANDA KAN SEPUH Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
...
for brayen in range(10000):
    ...
    u1 = f"Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/21A5277j [FBAN/FBIOS;FBDV/iPhone14,3;FBMD/iPhone;FBSN/iOS;FBSV/17.0;FBSS/3;FBID/phone;FBLC/it_IT;FBOP/5]"
    u2 = f"Mozilla/5.0 (Linux; Android 13; SAMSUNG SM-A245F) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/19.0 Chrome/102.0.5005.125 Mobile Safari/537.36"
