...
author   = 'lukman'
facebook = 'lukman (https://www.facebook.com/bangbros.com.ye)'
whatsapp = '0857 2941 6714'
komen    = random.choice(
	 ['hello bang😎','Keren Suhu','Salam kenal bang♥','Keren anjay','Kelazz','GAY YOK❤','Sehat selalu bang♥','mantap bang😎']
)
...
def Banner():
 ...
 ╠╩╗╠╦╝║ ║ ║ ║╣   ╠╣ ╠╩╗
 ╚═╝╩╚═╚═╝ ╩ ╚═╝  ╚  ╚═╝ 
 ( Di Buat oleh [bold green]Man[bold white] ) '''
