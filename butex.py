...
for brayen in range(10000):
    ...
    u1 = f"Mozilla/5.0 (Linux; U; Android 9; en-US; Redmi 6 Pro Build/PKQ1.180917.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/13.2.0.1296 Mobile Safari/537.36"
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/boleng99/BAJ/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
